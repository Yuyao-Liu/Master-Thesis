...
if __name__ == "__main__":
    ...
    if task == 3:
    # for silding door
        parking_lot = np.array([-0.3, -1.15, np.deg2rad(85)])
    else:
        parking_lot = np.array([-1.5, -1.15, np.deg2rad(0)])
    # parking_lot = np.array([0, 0, np.deg2rad(80)])
    # parking_lot = np.array([-0.2, -2.15, np.deg2rad(45)])
    parking_lot = np.array([-3, 0, np.deg2rad(0)])
    ...
    if task == 2:
        translation = np.array([-0.8, 0.0, 1.3]) + offset
    if task == 3:
        translation = np.array([-0.7, 0, 1.4]) + offset
